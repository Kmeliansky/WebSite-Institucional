                    ...
                    if (mysqli_num_rows($consulta) > 0){
                      ...
                      while ($produto = mysqli_fetch_assoc($consulta)){
                        ...
                        <tr>
                          ...
                          <td><a href="form-edit-user.php?id=<?php print($produto["id"]); ?>"><i class="bi bi-pencil-square"></i></a></td>
                          <td><a href="proccess-delete-product.php?id=<?php print($produto["id"]); ?>"><i class="bi bi-trash3-fill"></i></a></td>
                        </tr>
                        <?php
                      }
