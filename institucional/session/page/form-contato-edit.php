...
<body>
    ...
    <form class="form border border-secondary-subtle shadow mb-5 bg-body-tertiary rounded" action="" method="post">
                <!--Edição de contatos-->
                <fieldset class="m-5 border-secondary-subtle">
                    <h2>Contato</h2>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Celular</label>
                        <input type="tel" class="input-txt form-control" id="celular" name="celular"
                            placeholder="Ex: (14)981228218">
                    </div>
                    <div class="mb-3"> 
